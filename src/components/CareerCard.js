    ...
    return (
        ...
        {linkRepo &&
            <div onClick={handleOnClick}>
                <div className="career-card-activable flex flex-col w-full pl-5 text-xl my-5">
                <h1 className='text-sm lg:text-xl'>{title} <span className='ml-2'>{year}</span><span className='ml-2'>{linkRepo && <FontAwesomeIcon className="cursor-pointer" icon={faGithub}/>}</span></h1>
