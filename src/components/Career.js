        ...
        <div id="career" className="w-4/5 lg:w-1/2 container mx-auto flex items-center flex-col my-20 ">
            ...
            {showExperience &&
                <div id="experience" className='flex flex-col mt-10 animate-fade-right'>
                    ...
                    <CareerCard year='Ago. 2023 - Jul. 2024' title='Laboratory assistant - USM' subtitle='Computing laboratory' description='I was responsible to administrate systems ands ervices offered by computing laboratory.' linkRepo=''/>
